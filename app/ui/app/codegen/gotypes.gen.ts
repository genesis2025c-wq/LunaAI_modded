...
export class Chat {
    ...
    constructor(source: any = {}) {
        ...
        this.private_mode = source["private_mode"];
    }
...
export class Settings {
    ...
    constructor(source: any = {}) {
        ...
        this.airplane_mode = source["airplane_mode"];
        this.turbo_enabled = source["turbo_enabled"];
        this.websearch_enabled = source["websearch_enabled"];
        this.think_enabled = source["think_enabled"];
        this.think_level = source["think_level"];
